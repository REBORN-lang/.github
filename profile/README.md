...
The **REBORN-lang** organization is actively working on making **REBORN** the best modern successor to [**C**](https://www.c-language.org/) thanks to low-level \
memory control and modernized, straightforward syntax that is both comprehensible for experienced **C** and **C++** developers and easy for beginners.
